...
public final class ScheduleLoader {
  ...
  public static void load(Context context, ScheduleDatabase db) {
    try {
      ...
      List<ServiceDate> serviceDates = getCalendarDates(getFile(context, R.raw.calendar_dates));
  ...
  /**
   * calendar: service_id => {weekday: bool, saturday: bool, sunday: bool, start_date: date,
   * end_date: date} CT-16APR-Caltrain-Weekday-01 => {weekday: false, saturday: true, sunday: false,
  ...
  /**
   * calendar_dates: service_id => [[date, exception_type]] CT-16APR-Caltrain-Weekday-01 =>
   * [[20160530,2]]
   */
  ...
  /** stop_name => [stop_id1, stop_id2] "San Francisco" => [70021, 70022] */
  ...
  /**
   * routes: { route_id => { service_id => { trip_id => [[station_id,
   * arrival_time/departure_time(seconds) ]] } } } { "Bullet" => { "CT-14OCT-XXX" => {
   * "650770-CT-14OCT-XXX" => [[70012, 29700], ...] } } }
   */
